...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:C0392B,50:E74C3C,100:EC7063&height=150&text=PRIYANKA%20KAVALI%20SUBRAMANYAM&fontSize=38&fontColor=FFFFFF&fontAlignY=35&desc=Full-Stack%20Developer%20•%20UI/UX%20Designer&descSize=16&descAlignY=52"/>
...
%%{init: {'theme':'dark'}}%%
graph LR
    A["Research & Ideation"] --> B["Wireframing & Prototyping"]
    B --> C["Visual Design"]
    C --> D["Development"]
    D --> E["Testing & Iteration"]

    style A fill:#C0392B,stroke:#FFFFFF,stroke-width:2px,color:#FFFFFF
    style B fill:#C0392B,stroke:#FFFFFF,stroke-width:2px,color:#FFFFFF
    style C fill:#C0392B,stroke:#FFFFFF,stroke-width:2px,color:#FFFFFF
    style D fill:#C0392B,stroke:#FFFFFF,stroke-width:2px,color:#FFFFFF
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <img src="https://img.shields.io/badge/Procreate-FF5733?style=flat-square&logo=procreate&logoColor=white" alt="Procreate" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <img src="https://img.shields.io/badge/Python_Unittest-3776AB?style=flat-square&logo=python&logoColor=white" alt="Python Unittest" />
